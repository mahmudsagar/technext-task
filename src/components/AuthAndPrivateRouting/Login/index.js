...
const Login = () => {
    ...
    return (
        <div className="container loginContainer">
            <div className="card">
                <h1 className={`text-center p-3 display-6 text-capitalize`}>Let us know Who you are</h1>
                <small className="text-center mb-5">You can use any user from jsonplaceholder users <br />
